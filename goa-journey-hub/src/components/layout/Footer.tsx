  ...
  <div className="bg-gray-800 py-8 mx-auto px-4 lg:px-0 grid grid-cols-1 md:grid-cols-4 gap-10">
    ...
    <div className="space-y-4">
      ...
      <ul className="space-y-2 text-lg">
        <li><Link to={data.links.home} className="hover:underline">Home</Link></li>
        <li><Link to={data.links.about} className="hover:underline">About</Link></li>
        <li><Link to={data.links.packages} className="hover:underline">Packages</Link></li>
        <li><Link to={data.links.services} className="hover:underline">Services</Link></li>
        <li><Link to={data.links.contact} className="hover:underline">Contact</Link></li>
      </ul>
    </div>
    ...
    <div className="space-y-4">
      ...
      <ul className="space-y-2 text-lg">
        ...
        <li><Link to="/policy" className="hover:underline">Cancellation Policy</Link></li>
      </ul>
    </div>
    ...
    <div className="space-y-4 mx-8 md:text-right">
      ...
      <div className="pt-6 flex md:justify-end items-center gap-2 text-gray-400 text-lg">
        ...
        <img src={Logo} alt="Zenelait" className="w-28 opacity-80 rounded-xl bg-white" />
      </div>
    </div>
